		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Power Factor Validation - Non Engineering",
									"targetURL": "#comsaplhmrzpowerfactornoneng-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaplhmrzpowerfactornoneng-display": {
								"semanticObject": "comsaplhmrzpowerfactornoneng",
								"action": "display",
								"description": "Power Factor Validation - Non Engineering",
								"title": "Power Factor Validation - Non Engineering",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.lh.mr.zpowerfactornoneng",
									"url": sap.ui.require.toUrl("com/sap/lh/mr/zpowerfactornoneng")
								}
							}
						}
					}
